...
# Removal: Echoed Descent removed as per user request to start at depth 1 always.

var abyssal_focus_level: int = 0
@export var abyssal_focus_max: int = 20
@export var abyssal_focus_base_cost: float = 1250000.0 # 1.25M Base
@export var abyssal_focus_cost_growth: float = 1.65
@export var dreamcloud_mult_step: float = 0.10

var dark_insight_level: int = 0
@export var dark_insight_max: int = 20
@export var dark_insight_base_cost: float = 1500000.0 # 1.5M Base
@export var dark_insight_cost_growth: float = 1.65
@export var thoughts_mult_step: float = 0.10

var abyss_veil_level: int = 0
@export var abyss_veil_max: int = 20
@export var abyss_veil_base_cost: float = 2000000.0 # 2M Base
@export var abyss_veil_cost_growth: float = 1.75
