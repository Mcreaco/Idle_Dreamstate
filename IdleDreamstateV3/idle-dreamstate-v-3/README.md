...
---
## 🔁 Prestige Layers
**Wake (Run Reset)** — Converts run performance into Memories and depth currency.
**Perm Perks (Memory Shop)** — Memory Engine, Calm Mind, Focused Will, Starting Insight, Stability Buffer, Offline Echo.
**Abyss Perks (Late Game)** — Unlock at Depth 15; start-depth boosts, instability reduction, further Control/Thoughts scaling.
---
## ⚙ Automation
- Auto Dive
- Auto Overclock
